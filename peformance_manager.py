...
def fig_prediction(pred_C,pred_V,real):
    ...
    print('regression results saved as following path :' + './Figure/exp_reg_' + time.ctime() +'.png ')
    return
...
def fig_metric_reg(reg_metric_C,reg_metric_V):
    ...
    print('metric_reg saved as following path :' + './Figure/metric_reg_' + time.ctime() +'.png ')
